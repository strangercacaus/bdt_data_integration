{{ config(
        ...
        post_hook=[
            ...
            "CREATE INDEX IF NOT EXISTS idx_id_user_seller ON {{ this }} (id_user_seller)",
            "CREATE INDEX IF NOT EXISTS idx_id_invoice ON {{ this }} (id_invoice)",
            "CREATE INDEX IF NOT EXISTS idx_id_buyer_creation ON {{ this }} (id_buyer_creation)",
            "CREATE INDEX IF NOT EXISTS idx_id_buyer_modification ON {{ this }} (id_buyer_modification)",
            "CREATE INDEX IF NOT EXISTS idx_creation_source ON {{ this }} (creation_source)",
            "CREATE INDEX IF NOT EXISTS idx_price ON {{ this }} (price)",
            "CREATE INDEX IF NOT EXISTS idx_market ON {{ this }} (market)",
            "CREATE INDEX IF NOT EXISTS idx_creation_source ON {{ this }} (creation_source)",
            "CREATE INDEX IF NOT EXISTS idx_warehouse_id ON {{ this }} (warehouse_id)",
        ],
    )}}
...
FROM {{source('bendito','bdt_raw_invoice')}}
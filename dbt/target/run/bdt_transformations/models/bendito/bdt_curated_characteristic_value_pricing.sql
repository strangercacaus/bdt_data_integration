  ...
  create  table "bendito_intelligence"."default_schema"."bdt_curated_characteristic_value_pricing__dbt_tmp"
...
FROM "bendito_intelligence"."bendito"."bdt_raw_characteristic_value_pricing"
  );

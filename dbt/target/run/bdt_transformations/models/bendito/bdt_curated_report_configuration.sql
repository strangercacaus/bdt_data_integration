  ...
  create  table "bendito_intelligence"."default_schema"."bdt_curated_report_configuration__dbt_tmp"
...
FROM "bendito_intelligence"."bendito"."bdt_raw_report_configuration"
  );

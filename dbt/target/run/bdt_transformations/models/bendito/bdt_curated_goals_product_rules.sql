  ...
  create  table "bendito_intelligence"."default_schema"."bdt_curated_goals_product_rules__dbt_tmp"
...
FROM "bendito_intelligence"."bendito"."bdt_raw_goals_product_rules"
  );

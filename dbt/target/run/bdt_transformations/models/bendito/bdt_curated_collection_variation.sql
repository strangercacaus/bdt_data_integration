  ...
  create  table "bendito_intelligence"."default_schema"."bdt_curated_collection_variation__dbt_tmp"
...
FROM "bendito_intelligence"."bendito"."bdt_raw_collection_variation"
  );

  ...
  create  table "bendito_intelligence"."public"."btx_company__dbt_tmp"
...
from
	bitrix.btx_curated_company x
left join bitrix.btx_curated_user x1
	on x.id_criado_por = x1.id
left join bitrix.btx_curated_user x2

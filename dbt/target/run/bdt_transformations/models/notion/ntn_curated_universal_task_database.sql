  ...
  create  table "bendito_intelligence"."notion"."ntn_curated_universal_task_database__dbt_tmp"
...
from "bendito_intelligence"."notion"."ntn_processed_universal_task_database"
  );
